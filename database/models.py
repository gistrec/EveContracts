...
class Contract(Base):
    ...
    title = Column(String(126), nullable=True, comment="Title of the contract")
    ...
    days_to_complete = Column(BigInteger, nullable=True,  comment="Number of days to perform the contract")

    # Couriers contracts data
    start_location_id = Column(BigInteger, nullable=True, comment="Start location ID (for Couriers contract)")
    end_location_id   = Column(BigInteger, nullable=True, comment="End location ID (for Couriers contract)")

    collateral        = Column(Numeric(18, 2), nullable=True, comment="Collateral price (for Couriers only)")
    reward            = Column(Numeric(18, 2), nullable=True, comment="Remuneration for contract (for Couriers only)")

    # Additional contract data
    buyout = Column(Numeric(18, 2), nullable=True, comment="Buyout price (for Auctions only)")
    price  = Column(Numeric(18, 2), nullable=True, comment="Price of contract (for ItemsExchange and Auctions)")
